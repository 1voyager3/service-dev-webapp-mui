...
const transporter = nodemailer.createTransport({
    service: 'Gmail',
    auth: {
        // @desc testing email and password or should be used company noreply email
        // before make sure it's registered in firebase config
...
exports.sendMail = functions.https.onRequest((request, response) => {
    ...
    cors(request, response, () => {
        ...
        // @desc sending to a company
        mailOptions = {
            from: 'Demo Development',
            // @desc should be used company noreply email
            to: process.env.DEV_EMAIL,
